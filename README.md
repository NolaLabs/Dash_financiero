...
- **Login:** tu correo · contraseña `[redactado]`
...
Abrí esa URL (en el celular o el computador) y entrá directo con tu correo + `[redactado]` — la conexión ya viene puesta. Tus cambios se sincronizan en vivo entre todos tus dispositivos.
